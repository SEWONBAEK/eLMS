  ...
  <div class="main-container">
        ...
        <main>
            ...
            <div class="view-footer">
                <button type="button" class="btn-list" onclick="document.location='list.jsp'">목록으로</button>&nbsp;&nbsp;
                <button class="btn-apply" onclick="document.location='update.jsp'">수정</button>&nbsp;&nbsp;
                <button class="btn-delete" onclick="document.location='list.jsp'">삭제</button>
            </div>
        </main>
    </div>
