            ...
            <div class="content-header">
                ...
                <nav aria-label="breadcrumb">
                    <div class="breadcrumb">
                        <a href="list.jsp">과제관리 &nbsp; </a> > &nbsp; <span>과제작성</span>
                    </div>
                </nav>
            </div>
            ...
            <div class="submit-card">
                <form>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control custom-input" placeholder="제출할 과제의 제목을 입력하세요.">
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control custom-input" placeholder="과제에 대한 보충 설명이나 내용을 입력하세요"></textarea>
                    </div>

                    <!-- 버튼 영역 -->
                    <div class="btn-container">
                        <a href="view.jsp"><button type="button" class="btn-submit">등록</button></a>
                        <a href="view.jsp"><button type="button" class="btn-cancel">취소</button></a>
                    </div>
                </form>
            </div>
        </main>
