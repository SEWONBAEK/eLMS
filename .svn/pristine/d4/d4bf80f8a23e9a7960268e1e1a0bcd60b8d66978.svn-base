    ...
    <div class="main-container">
        <aside>
            <div class="side-menu-top">
                ...
                <a href="../student/list.jsp" class="menu-item active">학생 관리</a>
            </div>
        </aside>
		<!-- 본문 내용 -->
			...
			<table class="custom-table">
				...
				<tbody>
					<tr>
						...
						<td>컴퓨터공학과</td>
						<td>2024-05-15</td>
						<td><span class="badge-status status-enrolled">재학</span></td>
					</tr>
					<tr>
						<td><input type="checkbox" class="form-check-input"></td>
						<td>181</td>
						...
						<td>데이터분석과</td>
						<td>2024-05-12</td>
						<td><span class="badge-status status-leave">휴학</span></td>
					</tr>
					<tr>
						<td><input type="checkbox" class="form-check-input"></td>
						<td>180</td>
						...
						<td>정보통신학과</td>
						<td>2024-05-01</td>
						<td><span class="badge-status status-expelled">제적</span></td>
					</tr>
				</tbody>
			</table>
