...
<div class="main-container">
	<aside>
		<div class="side-menu-top">
			<a href="../notice/list.do" class="menu-item active">공지사항</a> <a
				href="../teacher/list.do" class="menu-item">교수 관리</a> <a
				href="../student/list.do" class="menu-item">학생 관리</a>
		</div>
	</aside>
	<!-- 본문 내용 -->
	<main>
		<div class="d-flex justify-content-between align-items-center">
			...
			<button class="btn-batch-approve"
				onclick="document.location='write.do'">공지사항 작성</button>
		</div>
		<br>
		...
		<table class="notice-table">
			...
			<tbody>
				<c:forEach var="vo" items="${ list }" varStatus="vs">
					<tr>
						<td class="col-no">${total - ((pageno - 1) * 10) - vs.index}</td>
		...
		<div class="pagination gap-2" style="text-align: center;">
			<c:if test="${ startbk != 1 }">
				<a href="list.do?kind=${ kind }&key=${ key }&page=${ startbk - 1 }" class="page-num">◀</a>
			</c:if> 
